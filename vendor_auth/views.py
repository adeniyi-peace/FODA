...
# from .forms import VendorRegistrationForm,  VendorSigninForm
...
#         return render(request, "vendor_auth/signup.html", context=context)
...
#             vendor.generate_verification_code()
...
#         return render(request, "vendor_auth/login.html", context=context)
        

#     def post(self, request):
#         form = VendorSigninForm(request, request.POST)
...
#     def get(self, request):
#         return render(request, "vendor_auth/email_code_verification.html")
    
#     def post(self, request):
#         code = request.POST.get("verification_code","")

#         try:
#             vendor = Vendor.objects.get(verification_code=code, is_active=False) 

#             if not vendor.is_verification_code_valid():
...
# vendor_auth/views.py
from django.shortcuts import render, redirect
from django.contrib.auth import authenticate, login
from .forms import VendorLoginForm, VendorSignUpForm
...
def vendor_signup_view(request):
    ...
    return render(request, "vendor_auth/signup.html", {"form": form})
...
def vendor_login_view(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            vendor = authenticate(request, email=email, password=password)
            if vendor:
    ...
    return render(request, "vendor_auth/login.html", {"form": form})
